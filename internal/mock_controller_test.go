...
func (_m *MockController) DescribeInstances(ctx context.Context, instanceIDs []string) ([]internal.Instance, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]internal.Instance, error)); ok {
		return rf(ctx, instanceIDs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string) []internal.Instance); ok {
...
func (_m *MockController) GetAutoscalingGroup(ctx context.Context) (*internal.AutoScalingGroup, error) {
	ret := _m.Called(ctx)
	...
	var r0 *internal.AutoScalingGroup
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*internal.AutoScalingGroup, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *internal.AutoScalingGroup); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*internal.AutoScalingGroup)
		}
	}
...
func (_m *MockController) ScaleUpASG(ctx context.Context, desiredCapacity int) error {
